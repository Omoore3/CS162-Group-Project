...
private:
	...
	string email;
	string password;
	Account* accPtr[4]; //each account will have an assigned number: 0 for CD, 1 for Money Market, etc. TO BE DEFINED
protected:
...
public:
	...
	Person();
	void createAccount(long num, double balance, int type);
